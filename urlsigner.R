...
#' 
#' This code was developed to support signing in the ggmap package. It has worked for me in this context, but isn't
#' widely tested in other scenarios.
#' 
#' @example
#' # Dependent on the following packages available from CRAN:
#' \dontrun{
#' install.packages(c("base64enc", "urltools", "digest"))
#' 
#' signedurl <- signurl(url, secret)
#' }
